...
<body onselectstart="return false">
  <div id="signature-pad" class="m-signature-pad">
    ...
    <div class="m-signature-pad--footer">
      ...
      <button type="button" class="button clear" data-action="clear" style="display: none"><%clear%></button>
      <button type="button" class="button save" data-action="save" style="display: none"><%confirm%></button>
    </div>
  </div>
