...
export function getDims(user) {
  ...
  let aiSource, aiWidth, aiHeight, aiRight, aiBottom, aiTopMargin;

  //aiSource = require('../images/new/1x-AI-cta-bar-empty.png');
  aiWidth = 200;
  aiHeight = 100;
  aiTopMargin = 500;

  // user agent determination iOS || Android ------------------------------------
  if (Platform.OS === 'ios') {
    // IPHONE 8 ------------------------------------
    if (screenHeight < 700) {
      bgSource = require('../images/main/1x.750.IPH/1x-main-background-750_1334_IPH.jpg');
      spacing1 = 0;
      spacing2 = 14; //above Connect a Bill
      spacing3 = isNewUser ? 77 : 65; //anon:reg
      //spacing4 = 22;  //CONNECT topHeader
      spacing4 = isNewUser ? 35 : 15; //space between connect + bills   anon:user

      //spacing5 = 40;  //MONEY topheader
      spacing5 = isNewUser ? 40 : 0; //anon:reg
      ...
      connectBillHeight = 60;
      emptyMargin = 20;
      emptyFontSize = 12; //font size of bill provider labels
      ...
      if (screenWidth > 375) {
        spacing2 = 56; //top header Above Connect Title (11 & MAX)
        spacing3 = isNewUser ? 120 : 104;
        spacing4 = isNewUser ? 38 : 30; //CONNECT + BILLS space between
        spacing5 = isNewUser ? 130 : 0; //MONEY topHeader -- EDIT THIS AI SPACER
        connectBillWidth = 416;
        connectBillHeight = 60;
        payBillWidth = 414;
        payBillHeight = 63;
      } else {
        ...
        spacing5 = isNewUser ? 130 : 71; //topheader MONEY
        connectBillWidth = 375;
      ...
      //spacing2 = 65;    //connect a bill - header padding
      //spacing4 = 30;    //bills <> connect padding
      //spacing5 = 20;    //money top padding
  ...
  gameSource = require('../images/new/3x-daily-game-btn.png');
